...
sealed case class DefArgList(args:List[(Reference,Literal[Any])]) extends AST

sealed case class FunctionDef(name: String, args:ArgList, defaults:DefArgList, body:Block) extends Statement
